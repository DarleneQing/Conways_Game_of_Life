...
public class Game {
    ...
    public void setUpPlayers(){
        ...
        if (!this.colorornot) {
            GameContext gameContext = new GameContext(new GameuseSymbol());
            this.players = gameContext.SetupPlayers(this.numPlayers);
        }
        else{
            GameContext gameContext = new GameContext(new GameuseColor());
            this.players = gameContext.SetupPlayers(this.numPlayers);
        }
    ...
    public int getPlayerRow(Player player1) {
        return 0;
    }

    public int getPlayerCol(Player player1) {
        return 0;
    }
}
