...
public class GameBoardTest {
    ...
    public void testGridBoard_Symbols() throws InvalidSize {
        ...
        assertEquals(" ", board.GetContent(4, 4).getGridSymbol());
        assertEquals(" ", board.GetContent(4, 5).getGridSymbol());
        assertEquals(" ", board.GetContent(4, 6).getGridSymbol());
        assertEquals("O", board.GetContent(4, 7).getGridSymbol());
    ...
    public void testGridBoard_Colors() throws InvalidSize {
        ...
        assertEquals(" ", board.GetContent(4, 5).getGridColor());
        assertEquals(" ", board.GetContent(4, 6).getGridColor());
        assertEquals("32", board.GetContent(4, 7).getGridColor());
